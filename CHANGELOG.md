...
- **T1 n=12 remeasure (docs):** [`docs/LONGMEMEVAL_BASELINE.md`](docs/LONGMEMEVAL_BASELINE.md) records kernel `ef6a3e9` locked mixed n=12: MiniLM/BGE still 10/12, `multi-session` still 0/2; retrieve now covers all inner haystack sessions. Not a README number.
