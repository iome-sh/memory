...
Filters apply **before** `Limit`. Default limit is **50** when ≤ 0. Listing is an O(n) filesystem scan today; a dedicated event-time index is not required for basic use.
